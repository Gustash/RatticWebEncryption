...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CredTemp'
        db.create_table(u'cred_credtemp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cred', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cred.Cred'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('access_granted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('access_expired', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('was_granted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'cred', ['CredTemp'])


        # Changing field 'Cred.created'
        db.alter_column(u'cred_cred', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting model 'CredTemp'
        db.delete_table(u'cred_credtemp')


        # Changing field 'Cred.created'
        db.alter_column(u'cred_cred', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'cred.credtemp': {
            ...
            'access_expired': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'access_granted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'cred': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cred.Cred']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'was_granted': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'cred.tag': {
