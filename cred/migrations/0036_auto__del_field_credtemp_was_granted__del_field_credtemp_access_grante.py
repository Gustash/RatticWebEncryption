...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CredTemp.was_granted'
        db.delete_column(u'cred_credtemp', 'was_granted')

        # Deleting field 'CredTemp.access_granted'
        db.delete_column(u'cred_credtemp', 'access_granted')

        # Deleting field 'CredTemp.access_expired'
        db.delete_column(u'cred_credtemp', 'access_expired')

        # Adding field 'CredTemp.date_granted'
        db.add_column(u'cred_credtemp', 'date_granted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'CredTemp.date_expired'
        db.add_column(u'cred_credtemp', 'date_expired',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'CredTemp.state'
        db.add_column(u'cred_credtemp', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CredTemp.was_granted'
        db.add_column(u'cred_credtemp', 'was_granted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CredTemp.access_granted'
        raise RuntimeError("Cannot reverse this migration. 'CredTemp.access_granted' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CredTemp.access_granted'
        db.add_column(u'cred_credtemp', 'access_granted',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CredTemp.access_expired'
        raise RuntimeError("Cannot reverse this migration. 'CredTemp.access_expired' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CredTemp.access_expired'
        db.add_column(u'cred_credtemp', 'access_expired',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)

        # Deleting field 'CredTemp.date_granted'
        db.delete_column(u'cred_credtemp', 'date_granted')

        # Deleting field 'CredTemp.date_expired'
        db.delete_column(u'cred_credtemp', 'date_expired')

        # Deleting field 'CredTemp.state'
        db.delete_column(u'cred_credtemp', 'state')
