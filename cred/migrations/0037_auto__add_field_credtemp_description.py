...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CredTemp.description'
        db.add_column(u'cred_credtemp', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CredTemp.description'
        db.delete_column(u'cred_credtemp', 'description')
