...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CredTemp.created'
        db.alter_column(u'cred_credtemp', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'CredTemp.created'
        db.alter_column(u'cred_credtemp', 'created', self.gf('django.db.models.fields.DateTimeField')())
